...
def HomePage():
    ...
    st.markdown("<h5 style='color: #2B2A4C; text-align: left; font-family: montserrat'>Sex</h5>", unsafe_allow_html=True)
    ...
    st.markdown('<br>', unsafe_allow_html=True)
    st.markdown("<h5 style='color: #2B2A4C; text-align: left; font-family: montserrat'>Age</h5>", unsafe_allow_html=True)
    ...
    st.markdown('<br>', unsafe_allow_html=True)
    st.markdown("<h5 style='color: #2B2A4C; text-align: left; font-family: montserrat'>Hypertension</h5>", unsafe_allow_html=True)
    ...
    st.markdown('<br>', unsafe_allow_html=True)
    st.markdown('<br>', unsafe_allow_html=True)
    st.markdown("<h5 style='color: #2B2A4C; text-align: left; font-family: montserrat'>Heart Diseases</h5>", unsafe_allow_html=True)
    ...
    st.markdown('<br>', unsafe_allow_html=True)
    st.markdown("<h5 style='color: #2B2A4C; text-align: left; font-family: montserrat'>Smoking history</h5>", unsafe_allow_html=True)
    ...
    st.markdown('<br>', unsafe_allow_html=True)
    st.markdown("<h5 style='color: #2B2A4C; text-align: left; font-family: montserrat'>Body Mass Index</h5>", unsafe_allow_html=True)
    ...
    st.markdown('<br>', unsafe_allow_html=True)
    st.markdown("<h5 style='color: #2B2A4C; text-align: left; font-family: montserrat'>Hemoglobin A1c</h5>", unsafe_allow_html=True)
    ...
    st.markdown('<br>', unsafe_allow_html=True)
    st.markdown("<h5 style='color: #2B2A4C; text-align: left; font-family: montserrat'>Blood glucose level</h5>", unsafe_allow_html=True)
